...
class TestKauppa(unittest.TestCase):
    ...
    def test_tilinsiirto_metodia_kutsutaan_oikeilla_parametreilla_yksi_tuote(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_tilinsiirto_metodia_kutsutaan_oikeilla_parametreilla_kaksi_samaa_tuotetta(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_tilinsiirto_metodia_kutsutaan_oikeilla_parametreilla_kaksi_eri_tuotetta(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_tilinsiirto_metodia_kutsutaan_oikeilla_parametreilla_kaksi_tuotetta(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_tilinsiirto_metodia_kutsutaan_tuote_loppu(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_uusi_ostoskori_nollaa_ostoskorin(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_viitegeneraattori_generoi_uuden_arvon(self):
        pankki_mock = Mock()
